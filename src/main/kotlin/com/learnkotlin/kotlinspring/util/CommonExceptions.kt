...
class DuplicatedEmailException(override val code: Int = 4002, override val message: String = "email duplicated") :
    CommonExceptions(code, message)

class ServerException(override val code: Int = 500, override val message: String = "internal server error") :
    CommonExceptions(code, message)

class InvalidTokenException(override val code: Int = 500, override val message: String = "invalid token error") :
    CommonExceptions(code, message)
